	...
	for _, varData in ipairs(varList) do
		if varData.section then
			...
			elseif varData.type == "count" or varData.type == "integer" or varData.type == "countAllowZero" or varData.type == "float" or varData.type == "countDecimal1" then
				control = new("EditControl", {"TOPLEFT",lastSection,"TOPLEFT"}, {234, 0, 90, 18}, "", nil, (varData.type == "integer" and "^%-%d") or (varData.type == "float" and "^%d.") or (varData.type == "countDecimal1" and "^0-9.") or "%D", 7, function(buf, placeholder)
					if placeholder then
